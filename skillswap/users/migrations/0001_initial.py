# Generated by Django 4.2.7 on 2025-07-12 05:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('offered_skill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='offered_in_swaps', to='users.skill')),
                ('requested_skill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requested_in_swaps', to='users.skill')),
            ...
            options={
                'unique_together': {('from_user', 'to_user', 'offered_skill', 'requested_skill')},
            },
        ),
    ]
